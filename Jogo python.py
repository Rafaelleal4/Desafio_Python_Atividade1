...
print("Bem-vindo ao DC Heroe!\nEsse é um jogo de aventura em texto,\nonde suas escolhas determinarão o destino da sua jornada.")
...
print(f"Você acorda em mais um dia da sua vida patética até que derrepente aparece uma mulher misteriosa em seu quarto, que aparenta ser uma heroína poderosa que usa magia. \n ZATANA: Olá, {char_name}, me chamo Zatana. Todos os hérois do planeta estão lutando com o Darkseid nesse momento, eu não tenho muito tempo, ja tenho que voltar e ajudar eles. Precisamos de você, o coringa plantou uma bomba em uma mina de escavação aqui perto!")
print("ZATANA: Não consigo explicar mais, meu tempo aqui está acabando, você precisa ir impedir ele. Vou te dar alguns atributos dos melhores herois do mundo!")
char_class = 0
...
while True:
    ...
    if action == 1 and char_class == "Superman":
        ...
        if action == 1 and hp > 0:
            ...
            print("Você encontrou um bilhete com numeros da senha da bomba")
